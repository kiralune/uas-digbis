...
<main class="min-h-screen flex items-center justify-center px-4 py-10 bg-slate-50">
    <div class="max-w-3xl w-full rounded-[2rem] bg-white p-10 shadow-2xl border border-slate-200">
        <div class="mb-10 text-center">
            <h1 class="text-4xl font-black text-slate-900">Daftar Akun Baru</h1>
            <p class="mt-3 text-slate-500">Buat akun untuk membeli tiket dan menikmati event seru.</p>
        </div>
        ...
        <form action="{{ route('register.post') }}" method="POST" class="space-y-6">
            ...
            <button type="submit"
                    class="w-full rounded-2xl bg-indigo-600 py-4 text-white font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition">Daftar Sekarang</button>
        </form>
